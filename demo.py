...
def demo_all_features():
    ...
    url1 = (
        builder1.set_keywords("Python Developer")
    ...
    url2 = (
        builder2.set_keywords("Senior Data Scientist")
        .set_location("Remote")
    ...
    url3 = (
        builder3.set_keywords("director sales operations")
    ...
    url4 = (
        builder4.set_keywords("DevOps Engineer")
